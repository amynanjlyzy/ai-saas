									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">
											...
											<select id="sd-image-engine" name="sd-image-engine" class="form-select">
												<option value='none' selected>{{ __('Not Allowed') }}</option>	
												<option value='stable-diffusion-v1-5'>{{ __('Stable Diffusion v1.5') }}</option>
												<option value='stable-diffusion-512-v2-1'> {{ __('Stable Diffusion v2.1') }}</option>																															
												<option value='stable-diffusion-768-v2-1'> {{ __('Stable Diffusion v2.1-768') }}</option>																															
