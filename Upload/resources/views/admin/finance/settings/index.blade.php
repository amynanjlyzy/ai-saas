									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">								
											...
											<select id="paddle_sandbox" name="paddle_sandbox" class="form-select" data-placeholder="{{ __('Enable/Disable Paddle Sandbox') }}:">			
												<option value=1 @if (config('services.paddle.sandbox')  == true) selected @endif>{{ __('Enable') }}</option>
												<option value=0 @if (config('services.paddle.sandbox')  == false) selected @endif>{{ __('Disable') }}</option>
											</select>
